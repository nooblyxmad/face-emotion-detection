...
# Analyze every N seconds for butter like smooth performance
...
def analyze_emotion(frame_bgr):
    ...
    # Keep only our 5 primary emotions
    for e in EMOTIONS:
...
while True:
    ...
    # Run analysis every 'ANALYZE_EVERY' seconds (smoothness + much faster)
